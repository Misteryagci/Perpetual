...
public class SwipeDetector {
    ...
    public boolean isClick() { return detector.isClick(eventOne,eventTwo,velocityX,velocityY); }
    private class Gesticulate {
        ...
        public boolean isClick (MotionEvent e1,MotionEvent e2,float velocityX,float velocityY)
        {
            return (!(isUpSwipe(e1,e2,velocityY)))&&(!(isDownSwipe(e1,e2,velocityY))) && (!(isLeftSwipe(e1,e2,velocityX))) && (!(isRightSwipe(e1,e2,velocityX)));
        }
